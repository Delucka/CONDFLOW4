-- ==========================================
-- MIGRATION 0072: Template de e-mail aponta pro domínio oficial emissaonline.com
-- (antes: condominios-gamma.vercel.app — que agora só redireciona). Igual à 0066,
-- trocando a base do GIF do pinguim e do botão "Abrir no CondoFlow".
-- ==========================================
...
RETURNS text LANGUAGE sql IMMUTABLE AS $$
  SELECT
    ...
    ||     '<td style="vertical-align:middle;width:48px;"><img src="https://emissaonline.com/email-penguin.gif" width="48" height="48" alt="" style="display:block;border-radius:14px;border:0;"></td>'
