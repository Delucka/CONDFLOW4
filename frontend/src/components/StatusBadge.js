...
const EMISSAO_STATUS = {
  ...
  'aguardando_relatorio':      { label: 'Aguardando relatório', classes: 'bg-amber-50 text-amber-700 border-amber-200',       dot: 'bg-amber-500' },
  ...
  'pendente':                  { label: 'Com gerente',          classes: 'bg-amber-50 text-amber-700 border-amber-200',    dot: 'bg-amber-500' },
  'pendente_gerente':          { label: 'Com gerente',          classes: 'bg-amber-50 text-amber-700 border-amber-200',    dot: 'bg-amber-500' },
  'aguardando gerente':        { label: 'Com gerente',          classes: 'bg-amber-50 text-amber-700 border-amber-200',    dot: 'bg-amber-500' },
  'pendente_sup_gerentes':     { label: 'Com sup. gerentes',    classes: 'bg-amber-50 text-amber-700 border-amber-200', dot: 'bg-amber-500' },
...
const PROCESSO_STATUS = {
  ...
  'emitido':              { label: 'Emitido',             classes: 'bg-violet-50 text-violet-700 border-violet-200',    dot: 'bg-violet-500' },
};
