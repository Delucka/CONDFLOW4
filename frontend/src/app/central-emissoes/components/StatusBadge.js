export default function StatusBadge({ status }) {
  ...
  const map = {
    ...
    'pendente_gerente': { label: 'Com gerente', class: 'bg-amber-50 text-amber-700 border-amber-200' },
    'pendente_sup_gerentes': { label: 'Com sup. gerentes', class: 'bg-amber-50 text-amber-700 border-amber-200' },
    'pendente_sup_contabilidade': { label: 'Com sup. contabilidade', class: 'bg-amber-50 text-amber-700 border-amber-200' },
    'aprovado': { label: 'Aguardando registro', class: 'bg-violet-50 text-violet-700 border-violet-200' },
    ...
    'pendente': { label: 'Com gerente', class: 'bg-amber-50 text-amber-700 border-amber-200' },
    'aguardando gerente': { label: 'Com gerente', class: 'bg-amber-50 text-amber-700 border-amber-200' },
    'aguardando chefe': { label: 'Com sup. gerentes', class: 'bg-amber-50 text-amber-700 border-amber-200' },
